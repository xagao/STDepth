...
class MonoDataset(data.Dataset):
    ...
    def __init__(self,
        ...
        self.num_scales = 1
        self.interp = transforms.functional.InterpolationMode.LANCZOS  #a high-quality downsampling filter
        ...
        for i in self.frame_idxs:
            if i == "s":
                ...
                try:
                    ...
                    #print(f"File not found. Skipping this sample.")
                    return self.__getitem__(index + 1)  # 跳过当前样本，继续选择下一个样本
